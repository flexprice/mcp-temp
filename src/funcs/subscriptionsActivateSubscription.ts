...
import {
  ...
  ActivateSubscriptionRequest$zodSchema,
} from "../models/activatesubscriptionop.js";
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => ActivateSubscriptionRequest$zodSchema.parse(value$),
  ...
  const path$ = pathToFunc("/subscriptions/{id}/activate")(
    pathParams$,
  );
