...
import {
  ...
  GetCustomerInvoiceSummaryRequest$zodSchema,
} from "../models/getcustomerinvoicesummaryop.js";
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => GetCustomerInvoiceSummaryRequest$zodSchema.parse(value$),
  ...
  const path$ = pathToFunc("/customers/{id}/invoices/summary")(
    pathParams$,
  );
