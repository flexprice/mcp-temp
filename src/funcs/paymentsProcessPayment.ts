...
import {
  ...
  ProcessPaymentRequest$zodSchema,
} from "../models/processpaymentop.js";
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => ProcessPaymentRequest$zodSchema.parse(value$),
  ...
  const path$ = pathToFunc("/payments/{id}/process")(
    pathParams$,
  );
