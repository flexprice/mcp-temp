...
import {
  ...
  HandleRazorpayWebhookRequest$zodSchema,
} from "../models/handlerazorpaywebhookop.js";
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => HandleRazorpayWebhookRequest$zodSchema.parse(value$),
