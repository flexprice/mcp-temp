...
} from "../models/updatesubscriptionlineitemop.js";
...
export function subscriptionsUpdateSubscriptionLineItem(
  ...
  request: UpdateSubscriptionLineItemRequest,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => UpdateSubscriptionLineItemRequest$zodSchema.parse(value$),
  ...
  const path$ = pathToFunc("/subscriptions/lineitems/{id}")(
    pathParams$,
  );
