...
import {
  ...
  GetCustomerUpcomingGrantsRequest$zodSchema,
} from "../models/getcustomerupcominggrantsop.js";
...
export function customersGetCustomerUpcomingGrants(
  ...
  request: GetCustomerUpcomingGrantsRequest,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => GetCustomerUpcomingGrantsRequest$zodSchema.parse(value$),
  ...
  const path$ = pathToFunc("/customers/{id}/grants/upcoming")(
    pathParams$,
  );
