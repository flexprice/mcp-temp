...
import {
  ...
  UpdatePriceUnitRequest$zodSchema,
} from "../models/updatepriceunitop.js";
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => UpdatePriceUnitRequest$zodSchema.parse(value$),
  ...
  const path$ = pathToFunc("/prices/units/{id}")(
    pathParams$,
  );
