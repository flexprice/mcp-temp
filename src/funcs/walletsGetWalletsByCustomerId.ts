...
import {
  ...
  GetWalletsByCustomerIdRequest$zodSchema,
} from "../models/getwalletsbycustomeridop.js";
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => GetWalletsByCustomerIdRequest$zodSchema.parse(value$),
  ...
  const path$ = pathToFunc("/customers/{id}/wallets")(
    pathParams$,
  );
