...
import {
  ...
  ProcessCreditNoteRequest$zodSchema,
} from "../models/processcreditnoteop.js";
...
export function creditNotesProcessCreditNote(
  ...
  request: ProcessCreditNoteRequest,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => ProcessCreditNoteRequest$zodSchema.parse(value$),
  ...
  const path$ = pathToFunc("/creditnotes/{id}/finalize")(
    pathParams$,
  );
