...
import {
  ...
  HandleMoyasarWebhookRequest$zodSchema,
} from "../models/handlemoyasarwebhookop.js";
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => HandleMoyasarWebhookRequest$zodSchema.parse(value$),
