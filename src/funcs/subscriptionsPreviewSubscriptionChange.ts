...
import {
  ...
  PreviewSubscriptionChangeRequest$zodSchema,
} from "../models/previewsubscriptionchangeop.js";
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => PreviewSubscriptionChangeRequest$zodSchema.parse(value$),
  ...
  const path$ = pathToFunc("/subscriptions/{id}/change/preview")(
    pathParams$,
  );
