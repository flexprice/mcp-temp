...
import {
  ...
  UpdateEntitlementRequest$zodSchema,
} from "../models/updateentitlementop.js";
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => UpdateEntitlementRequest$zodSchema.parse(value$),
  ...
  const path$ = pathToFunc("/entitlements/{id}")(
    pathParams$,
  );
