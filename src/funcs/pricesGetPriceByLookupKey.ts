...
import {
  ...
  GetPriceByLookupKeyRequest$zodSchema,
} from "../models/getpricebylookupkeyop.js";
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => GetPriceByLookupKeyRequest$zodSchema.parse(value$),
  ...
  const path$ = pathToFunc("/prices/lookup/{lookup_key}")(
    pathParams$,
  );
