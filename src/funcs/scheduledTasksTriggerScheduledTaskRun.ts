...
import {
  ...
  TriggerScheduledTaskRunRequest$zodSchema,
} from "../models/triggerscheduledtaskrunop.js";
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => TriggerScheduledTaskRunRequest$zodSchema.parse(value$),
  ...
  const path$ = pathToFunc("/tasks/scheduled/{id}/run")(
    pathParams$,
  );
