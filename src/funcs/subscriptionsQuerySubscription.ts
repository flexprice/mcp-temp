...
import {
  ...
  TypesSubscriptionFilter$zodSchema,
} from "../models/typessubscriptionfilter.js";
...
export function subscriptionsQuerySubscription(
  ...
  request: TypesSubscriptionFilter,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => TypesSubscriptionFilter$zodSchema.parse(value$),
