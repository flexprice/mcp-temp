...
import {
  ...
  HandleHubspotWebhookRequest$zodSchema,
} from "../models/handlehubspotwebhookop.js";
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => HandleHubspotWebhookRequest$zodSchema.parse(value$),
