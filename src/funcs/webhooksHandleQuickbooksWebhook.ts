...
import {
  ...
  HandleQuickbooksWebhookRequest$zodSchema,
} from "../models/handlequickbookswebhookop.js";
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => HandleQuickbooksWebhookRequest$zodSchema.parse(value$),
