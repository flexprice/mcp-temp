...
import {
  ...
  GetSubscriptionScheduleRequest$zodSchema,
} from "../models/getsubscriptionscheduleop.js";
...
export function subscriptionsGetSubscriptionSchedule(
  ...
  request: GetSubscriptionScheduleRequest,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => GetSubscriptionScheduleRequest$zodSchema.parse(value$),
