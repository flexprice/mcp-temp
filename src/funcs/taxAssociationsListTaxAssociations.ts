...
import {
  ...
  ListTaxAssociationsRequest$zodSchema,
} from "../models/listtaxassociationsop.js";
...
export function taxAssociationsListTaxAssociations(
  ...
  request?: ListTaxAssociationsRequest | undefined,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => ListTaxAssociationsRequest$zodSchema.optional().parse(value$),
