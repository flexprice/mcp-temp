...
import {
  ...
  TriggerInvoiceCommsWebhookRequest$zodSchema,
} from "../models/triggerinvoicecommswebhookop.js";
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => TriggerInvoiceCommsWebhookRequest$zodSchema.parse(value$),
  ...
  const path$ = pathToFunc("/invoices/{id}/comms/trigger")(
    pathParams$,
  );
