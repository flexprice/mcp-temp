...
import {
  ...
  CancelSubscriptionScheduleRequest$zodSchema,
} from "../models/cancelsubscriptionscheduleop.js";
...
export function subscriptionsCancelSubscriptionSchedule(
  ...
  request: CancelSubscriptionScheduleRequest,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => CancelSubscriptionScheduleRequest$zodSchema.parse(value$),
