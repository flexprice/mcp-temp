...
import {
  ...
  UpdateInvoicePaymentStatusRequest$zodSchema,
} from "../models/updateinvoicepaymentstatusop.js";
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => UpdateInvoicePaymentStatusRequest$zodSchema.parse(value$),
  ...
  const path$ = pathToFunc("/invoices/{id}/payment")(
    pathParams$,
  );
