...
import {
  ...
  DeleteScheduledTaskRequest$zodSchema,
} from "../models/deletescheduledtaskop.js";
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => DeleteScheduledTaskRequest$zodSchema.parse(value$),
  ...
  const path$ = pathToFunc("/tasks/scheduled/{id}")(
    pathParams$,
  );
