...
import {
  ...
  SyncPlanPricesRequest$zodSchema,
} from "../models/syncplanpricesop.js";
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => SyncPlanPricesRequest$zodSchema.parse(value$),
  ...
  const path$ = pathToFunc("/plans/{id}/sync/subscriptions")(
    pathParams$,
  );
