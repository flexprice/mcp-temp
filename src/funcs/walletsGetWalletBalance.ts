...
import {
  ...
  GetWalletBalanceRequest$zodSchema,
} from "../models/getwalletbalanceop.js";
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => GetWalletBalanceRequest$zodSchema.parse(value$),
  ...
  const path$ = pathToFunc("/wallets/{id}/balance/real-time")(
    pathParams$,
  );
