...
import {
  ...
  TerminateWalletRequest$zodSchema,
} from "../models/terminatewalletop.js";
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => TerminateWalletRequest$zodSchema.parse(value$),
  ...
  const path$ = pathToFunc("/wallets/{id}/terminate")(
    pathParams$,
  );
