...
import {
  ...
  VoidCreditNoteRequest$zodSchema,
} from "../models/voidcreditnoteop.js";
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => VoidCreditNoteRequest$zodSchema.parse(value$),
  ...
  const path$ = pathToFunc("/creditnotes/{id}/void")(
    pathParams$,
  );
