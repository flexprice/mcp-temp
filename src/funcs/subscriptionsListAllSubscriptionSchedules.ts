...
import {
  ...
  ListAllSubscriptionSchedulesRequest$zodSchema,
} from "../models/listallsubscriptionschedulesop.js";
...
export function subscriptionsListAllSubscriptionSchedules(
  ...
  request?: ListAllSubscriptionSchedulesRequest | undefined,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) =>
      ListAllSubscriptionSchedulesRequest$zodSchema.optional().parse(value$),
