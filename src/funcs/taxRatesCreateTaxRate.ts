...
import {
  ...
  DtoCreateTaxRateRequest$zodSchema,
} from "../models/dtocreatetaxraterequest.js";
...
export function taxRatesCreateTaxRate(
  ...
  request: DtoCreateTaxRateRequest,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => DtoCreateTaxRateRequest$zodSchema.parse(value$),
