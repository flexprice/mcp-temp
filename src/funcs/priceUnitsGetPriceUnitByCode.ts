...
import {
  ...
  GetPriceUnitByCodeRequest$zodSchema,
} from "../models/getpriceunitbycodeop.js";
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => GetPriceUnitByCodeRequest$zodSchema.parse(value$),
  ...
  const path$ = pathToFunc("/prices/units/code/{code}")(
    pathParams$,
  );
