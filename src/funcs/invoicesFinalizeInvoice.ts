...
import {
  ...
  FinalizeInvoiceRequest$zodSchema,
} from "../models/finalizeinvoiceop.js";
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => FinalizeInvoiceRequest$zodSchema.parse(value$),
  ...
  const path$ = pathToFunc("/invoices/{id}/finalize")(
    pathParams$,
  );
