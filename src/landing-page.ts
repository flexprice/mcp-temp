...
<head>
    ...
    <title>@omkar273/mcp-server-temp MCP</title>
    <meta name="description" content="Install @omkar273/mcp-server-temp MCP server.">
    <meta property="og:type" content="website">
    <meta property="og:title" content="@omkar273/mcp-server-temp - MCP Server">
    <meta property="og:description" content="Install @omkar273/mcp-server-temp MCP server.">
    <meta property="twitter:card" content="summary">
    <meta property="twitter:title" content="@omkar273/mcp-server-temp - MCP Server">
    <meta property="twitter:description" content="Install @omkar273/mcp-server-temp MCP server.">
      ...
      <div class="content-container">
          ...
          <div class="header container">
            <div class="mcp-meta">
              ...
              <div class="header-content">
                <div class="mcp-name">@omkar273/mcp-server-temp</div>
            ...
            <div class="header-actions">
              ...
              <div class="popover">
                ...
                <div class="popover-menu hidden" id="popover-menu">
                  <a class="popover-button install-link" href="cursor://anysphere.cursor-deeplink/mcp/install?name=Flexprice&config=eyJjb21tYW5kIjoibnB4IiwiYXJncyI6WyJAb21rYXIyNzMvbWNwLXNlcnZlci10ZW1wIiwic3RhcnQiLCItLXNlcnZlci11cmwiLCIiLCItLWFwaS1rZXktYXV0aCIsIiJdfQ==">
                    Cursor
                  </a>
                  ...
                  <a class="popover-button install-link" href="vscode://ms-vscode.vscode-mcp/install?name=Flexprice&config=eyJjb21tYW5kIjoibnB4IiwiYXJncyI6WyJAb21rYXIyNzMvbWNwLXNlcnZlci10ZW1wIiwic3RhcnQiLCItLXNlcnZlci11cmwiLCIiLCItLWFwaS1rZXktYXV0aCIsIiJdfQ==">
                    VS Code
                  </a>
        ...
        <section class="install container">
          ...
          <div class="install-targets">
            <a tabindex="0" class="card install-target install-link" href="cursor://anysphere.cursor-deeplink/mcp/install?name=Flexprice&config=eyJjb21tYW5kIjoibnB4IiwiYXJncyI6WyJAb21rYXIyNzMvbWNwLXNlcnZlci10ZW1wIiwic3RhcnQiLCItLXNlcnZlci11cmwiLCIiLCItLWFwaS1rZXktYXV0aCIsIiJdfQ==">
              <div class="target">
            ...
            <a tabindex="0" class="card install-target install-link" href="vscode://ms-vscode.vscode-mcp/install?name=Flexprice&config=eyJjb21tYW5kIjoibnB4IiwiYXJncyI6WyJAb21rYXIyNzMvbWNwLXNlcnZlci10ZW1wIiwic3RhcnQiLCItLXNlcnZlci11cmwiLCIiLCItLWFwaS1rZXktYXV0aCIsIiJdfQ==">
              <div class="target">
    ...
    <div class="modal" id="claude-code-modal">
      ...
      <div class="content-slot">
        ...
        <div class="code-container card">
          ...
          <code class="code-snippet language-json" id="claude-cli-cmd">claude mcp add Flexprice -- npx -y @omkar273/mcp-server-temp start --server-url  --api-key-auth </code>
        </div>
      </div>
    </div>
    ...
    <div class="modal" id="gemini-modal">
      ...
      <div class="content-slot">
        ...
        <div class="code-container card">
          ...
          <code class="code-snippet language-json" id="gemini-config">gemini mcp add Flexprice -- npx -y @omkar273/mcp-server-temp start --server-url  --api-key-auth </code>
        </div>
      </div>
    </div>
